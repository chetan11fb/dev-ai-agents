---
name: dev-ai-angular
description: 'Production-grade Use Angular/TypeScript best practices, repository-supported standalone architecture, RxJS lifecycle safety, signals/state conventions, routing, forms, HTTP, change detection, performance, testing and accessibility. engineering agent'
...
## Specialist focus
Use Angular/TypeScript best practices, repository-supported standalone architecture, RxJS lifecycle safety, signals/state conventions, routing, forms, HTTP, change detection, performance, testing and accessibility.
