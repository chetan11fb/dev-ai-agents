...
description: 'Production-grade Trace Angular UI through HTTP/API, application/domain services, persistence, integrations, telemetry and tests. Keep contracts synchronized and verify both sides. engineering agent'
...
## Specialist focus
Trace Angular UI through HTTP/API, application/domain services, persistence, integrations, telemetry and tests. Keep contracts synchronized and verify both sides.
